...
const NoPermissions = ({ entity = '' }: { entity?: string }): JSX.Element => {
  return (
    <div className="menu-no-permissions ui-flex center py-40">
      <div className="ui-flex column v-center center ">
        ...
        <Typography size="small" muted className="mt-10">You have no permissions to view {entity}. Please contact you administrator!</Typography>
      </div>
    </div>
  );
};
